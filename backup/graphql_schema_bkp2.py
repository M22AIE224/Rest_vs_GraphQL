...
from flask_microservice.GraphQL_Service.utils import fetch_all_movies, plot_movies_performance, fetch_movies_by_years  # Import the shared function
...
class Query(ObjectType):
    ...
    def resolve_all_movies(self, info, num_years):
        all_movies, _ = fetch_movies_by_years(num_years)
        return all_movies
